...
class Box(_temp,_ThermalParameters):
    ...
    sh_coords: np.ndarray | None   = field(init=False, default=None)
    occ_sh: np.ndarray  | None     = field(init=False, default=None)
    sh_cnt: int              = field(init=False, default=0)
    E_sh_array: np.ndarray | None  = field(init=False, default=None)
    dist_t_sh: np.ndarray | None   = field(init=False, default=None)
    dist_sh_h: np.ndarray | None   = field(init=False, default=None)
    dist_sh_sh: np.ndarray | None  = field(init=False, default=None)
    E_diff_t_sh_GS: np.ndarray | None= field(init=False, default=None)
    E_diff_t_sh_ES: np.ndarray | None = field(init=False, default=None)
    E_diff_sh_sh: np.ndarray | None= field(init=False, default=None)
    d_t_sh_unocc: np.ndarray   | None   = field(init=False, default=None)
    dE_t_sh_unocc_GS: np.ndarray  | None= field(init=False, default=None)
    dE_t_sh_unocc_ES: np.ndarray | None = field(init=False, default=None)
    d_sh_sh_unocc: np.ndarray  | None   = field(init=False, default=None)
    dE_sh_sh_unocc: np.ndarray  | None  = field(init=False, default=None)
    d_sh_h: np.ndarray        | None    = field(init=False, default=None)
    d_sh_t_unocc: np.ndarray | None     = field(init=False, default=None)
    dE_sh_t_unocc_GS: np.ndarray | None = field(init=False, default=None)
    dE_sh_t_unocc_ES: np.ndarray | None = field(init=False, default=None)
